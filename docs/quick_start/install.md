...
```kotlin
implementation("com.baidubce:appbuilder:0.9.1")
```
...
```
#### 本地导入
点击[链接](https://repo1.maven.org/maven2/com/baidubce/appbuilder/0.9.1/appbuilder-0.9.1.jar) 下载Jar包，将Jar包导入到项目目录下。
...
``` shell
docker pull registry.baidubce.com/appbuilder/appbuilder-sdk-devel:0.9.1
```
