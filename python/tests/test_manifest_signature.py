...
class TestManifestSignature(unittest.TestCase):
    ...
    def test_decorator_google_style_function_description_no_args(self):
        ...
        assert view.function["description"] == """A function to test function description.
    ...
    def test_decorator_google_style_basic(self):
        ...
        assert view.function["description"] == """Function with required parameter.
        ...
        assert name_property["description"] is None, "'name' description does not match None"
    ...
    def test_decorator_google_style_list(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "List[str]", "'val' type does not match 'List[str]'"
    ...
    def test_decorator_google_style_list_of_dicts(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "List[Dict[str, List[str]]]", "'val' type does not match 'List[Dict[str, List[str]]]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_dict(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "Dict[str, Any]", "'val' type does not match 'Dict[str, Any]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_dict_of_lists(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "Dict[str, List[Dict[str, List[str]]]]", "'val' type does not match 'Dict[str, List[Dict[str, List[str]]]]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_union_simple(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "Union[str, int, Any]", "'val' type does not match 'Union[str, int, Any]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_union(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "Union[str, List[int]]", "'val' type does not match 'Union[str, List[int]]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_union_nest1_dict(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "Union[float, Dict[str, int]]", "'val' type does not match 'Union[float, Dict[str, int]]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_union_combine(self):
        ...
        # 验证 'val' 参数的各项属性
        assert val_property["type"] == "Union[float, str, int]", "'val' type does not match 'Union[float, str, int]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_optional(self):
        ...
        assert val_property["type"] == "Optional[str]", "'val' type does not match 'Optional[str]'"
        assert val_property["required"] is False, "'val' required does not match False"
    ...
    def test_decorator_google_style_optional_list(self):
        ...
        assert val_property["type"] == "Optional[List[str]]", "'val' type does not match 'Optional[List[str]]'"
        assert val_property["required"] is False, "'val' required does not match False"
    ...
    def test_decorator_google_style_list_nest_optional(self):
        ...
        assert val_property["type"] == "List[Optional[str]]", "'val' type does not match 'List[Optional[str]]'"
        assert val_property["required"] is True, "'val' required does not match True"
    ...
    def test_decorator_google_style_union_nest_optional(self):
        ...
        assert val_property["type"] == "Union[int, str]", "'val' type does not match 'Union[int, str]'"
        assert val_property["required"] is False, "'val' required does not match False"
    ...
    def test_decorator_google_style_union_nest1_dict_optional_value(self):
        ...
        assert val_property["type"] == "Union[float, Dict[str, Optional[int]]]", (
