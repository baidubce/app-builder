...
from typing import Optional, Union, TypeAlias, Annotated, List
...
class AISearchResponse(BaseModel):
    ...
    is_safe: bool = Field(..., alias="isSafe", description="query是否安全")
    choices: List[Choice] = Field(
        ..., min_items=1, description="	模型生成的 completion 的选择列表"
    )
