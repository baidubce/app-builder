...
class AppBuilderClient(Component):
    ...
    def run(self, conversation_id: str,
        ...
        Args:
            ...
            tools(list[data_class.Tool|Manifest]): 一个Tool或Manifest组成的列表，其中每个Tool(Manifest)对应一个工具的配置, 默认为None
    ...
    def run_with_handler(self,
        ...
        Args:
            ...
            tools(list[data_class.Tool|Manifest], 可选): 一个Tool或Manifest组成的列表，其中每个Tool(Manifest)对应一个工具的配置, 默认为None
            stream (bool): 是否流式响应
