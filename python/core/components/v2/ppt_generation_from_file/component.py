...
import appbuilder
from appbuilder.core.components.ppt_generation_from_file.base import PPTGenerationFromFileArgs, DEFAULT_AUTHOR
...
class PPTGenerationFromFile(Component):
    ...
    def tool_eval(self, **kwargs):
        ...
        user_input = {
            'file_url': list(file_urls.values())[0]
        }
