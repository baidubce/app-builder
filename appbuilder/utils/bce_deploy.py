...
class AppbuilderSDKInstance:
    ...
    def build_user_data(self):
        ...
        user_data = (
            ...
            + "docker pull registry.baidubce.com/appbuilder/appbuilder-sdk-cloud:0.9.5\\n"
            + f"docker run -itd --net=host -v /root/test:{workspace} --name appbuilder-sdk registry.baidubce.com/appbuilder/appbuilder-sdk-cloud:0.9.5{workspace}/{self.run_script_name}"
        )
