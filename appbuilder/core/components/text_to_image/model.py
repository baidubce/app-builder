...
class Text2ImageSubmitRequest(BaseModel):
    ...
    pdf_file_num: Optional[str]
    change_degree: Optional[int] 
    text_content: Optional[str] 
    task_time_out: Optional[int]
    text_check: Optional[int]
...
class Text2ImageSubmitResponse(BaseModel):
    ...
    error_detail:Optional[Text2ImageSubmitErrorDetail]
...
class Text2ImageQueryResponseDate(BaseModel):
    task_id: Optional[str]
    task_status: Optional[str]
    task_progress_detail: Optional[float]
    task_progress: Optional[int]
    sub_task_result_list: Optional[list[object]]
    sub_task_status: Optional[str]
    sub_task_progress_detail: Optional[float]
    sub_task_progress: Optional[int]
    sub_task_error_code: Optional[str]
    final_image_list: Optional[list[object]]
...
class Text2ImageQueryResponse(BaseModel):
    ...
    data:Optional[Text2ImageQueryResponseDate]
